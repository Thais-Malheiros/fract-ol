...
/*   Updated: 2024/03/05 12:21:18 by tmalheir         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_change_color(t_fractal	*fractal)
{
	...
	temp = fractal->channel.r;
	fractal->channel.r = fractal->channel.g;
	fractal->channel.g = fractal->channel.b;
	fractal->channel.b = temp;
}
